<div class="main-menu">
	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li><a class="waves-effect parent-item js__control" href="#"><i
					...
					<ul class="sub-menu js__content">
						...
						<li><a href="icons-material-icons.html">Material Design
								Icons</a></li>
						<li><a href="icons-material-design-iconic.html">Material
								Design Iconic Font</a></li>
				...
				<li><a class="waves-effect" href="widgets.html"><i
			...
			<ul class="menu js__accordion">
				<li><a class="waves-effect parent-item js__control" href="#"><i
						class="menu-icon far fa-chart-bar"></i><span>Charts</span><span
						class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
				...
				<li class="current active"><a
					...
					<ul class="sub-menu js__content">
						...
						<li class="current"><a href="form-validation.html">Form
								Validation</a></li>
			...
			<ul class="menu js__accordion">
				...
				<li><a class="waves-effect parent-item js__control" href="#"><i
						class="menu-icon fa fas fa-file-alt"></i><span>Page</span><span
						class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
