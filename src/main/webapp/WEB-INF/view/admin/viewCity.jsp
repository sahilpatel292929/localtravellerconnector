							...
							<tbody>
									<c:forEach items="${cityList}" var="i" varStatus="j">
										<tr>
											...
											<td>
											  <a href="editCity?id=${i.cityId}" class="btn btn-violet btn-rounded btn-bordered waves-effect waves-light">Edit</a>
												
											</td>
											<td>
											<a href="deleteCity?id=${i.cityId}" class="btn btn-danger btn-rounded btn-bordered waves-effect waves-light">Delete</a>												
