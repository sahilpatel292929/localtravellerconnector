	...
	<div id="single-wrapper">
		<form action="#" class="frm-single">
			<div class="inside">
				...
				<!-- /.frm-title -->
				<div class="frm-input">
					<input type="email" placeholder="Email" class="frm-inp"><i
				...
				<div class="clearfix margin-bottom-20">
					<div class="checkbox primary">
						<input type="checkbox" id="accept"><label for="accept">I
				...
				<div class="row small-spacing">
					...
					<div class="col-md-6">
						<button type="button"
							...
							<i class="ico fa fa-facebook"></i><span>Facebook</span>
						</button>
					</div>
					<!-- /.col-md-6 -->
					<div class="col-md-6">
				...
				<!-- /.row -->
				<a href="page-login.html" class="a-link"><i
					class="fa fa-sign-in"></i>Already have account? Login.</a>
