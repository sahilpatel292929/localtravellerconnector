...
<link rel="stylesheet"
	href="adminResources/css/responsive.bootstrap.min.css">
			...
			<ul class="notice-list">
				...
				<li><a href="#"> <span class="avatar"><img
						...
						class="name">Anna William</span> <span class="desc">Like
							your post: “Facebook Messenger”</span> <span class="time">15
							min</span>
				</a></li>
				...
				<li><a href="#"> <span class="avatar"><img
						...
						class="name">Thomas William</span> <span class="desc">Like
							your post: “Facebook Messenger”</span> <span class="time">Oct,
							27</span>
				</a></li>
			</ul>
			<!-- /.notice-list -->
				...
				<div class="col-12">
					<div class="box-content">
						...
						<div class="dropdown js__drop_down">
							<a href="#"
								class="dropdown-icon fas fa-ellipsis-v js__drop_down_button"></a>
							<ul class="sub-menu">
							...
							<tbody>
									<c:forEach items="${stateList}" var="i" varStatus="j">
										<tr>
											...
											<td>
											  <a href="editstate?id=${i.stateId}" class="btn btn-violet btn-rounded btn-bordered waves-effect waves-light">Edit</a>
												
											</td>
											<td>
											<a href="deleteState?id=${i.stateId}" class="btn btn-danger btn-rounded btn-bordered waves-effect waves-light">Delete</a>												
