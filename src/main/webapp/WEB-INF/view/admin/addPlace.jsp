						...
						<form data-toggle="validator">
							...
							<div class="form-group">
	                         ...
	                         <div class="form-group">
								...
								<select name="Area Name" class="form-control" required>
							...
							<div class="form-group">
								<label for="inputName" class="control-label">Category Type</label> 
								<select name="Category Type" class="form-control" required>
									...
									<div class="form-group">
								<label for="inputName" class="control-label">Place Name</label> <input
