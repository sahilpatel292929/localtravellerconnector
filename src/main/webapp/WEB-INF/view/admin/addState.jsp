			...
			<div class="row small-spacing">
				<div class="col-12">
					<div class="box-content">
						...
						<f:form data-toggle="validator" action="insertState" modelAttribute="stateVO" method="post">
							<div class="form-group">
								<label for="inputName" class="control-label">State Name</label> 
								<!-- <input type="text" class="form-control" id="inputName" placeholder="State Name" required> -->
							 <f:input path="stateName" class="form-control" id="stateName" placeholder="State Name" required="required"/>
							</div>
							 <div class="form-group">
								<label for="inputEmail" class="control-label">State Description</label> 
								<!-- <input type="email" class="form-control" id="inputEmail" placeholder="Description" data-error="Bruh, that email address is invalid" required> -->
								      
								<f:textarea path="stateDescription" type="textarea" class="form-control" placeholder="Description" required="required"/> 
