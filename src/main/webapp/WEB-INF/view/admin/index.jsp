...
<!-- mCustomScrollbar -->
<link rel="stylesheet"
	href="adminResources/css/jquery.mCustomScrollbar.min.css">
...
<link rel="stylesheet" href="adminResources/css/fullcalendar.print.css"
	media='print'>
...
<body>
		...
		<div class="content">
			<ul class="notice-list">
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-1.jpg" alt=""></span> <span
						class="name">John Doe</span> <span class="desc">Like your
							post: “Contact Form 7 Multi-Step”</span> <span class="time">10
							min</span>
				</a></li>
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-2.jpg" alt=""></span> <span
				...
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-7.jpg" alt=""></span> <span
						class="name">Helen 987</span> <span class="desc">Like your
							post: “Facebook Messenger”</span> <span class="time">Yesterday</span>
				</a></li>
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-2.jpg" alt=""></span> <span
						class="name">Denise Jenny</span> <span class="desc">Like
							your post: “Contact Form 7 Multi-Step”</span> <span class="time">Oct,
							28</span>
				</a></li>
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-8.jpg" alt=""></span> <span
	...
	<div id="message-popup" class="notice-popup js__toggle" data-space="75">
		...
		<div class="content">
			<ul class="notice-list">
				...
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-3.jpg" alt=""></span> <span
				...
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-sm-5.jpg" alt=""></span> <span
				...
				<li><a href="#"> <span class="avatar"><img
							src="adminResources/image/avatar-5.jpg" alt=""></span> <span
	...
	<div id="color-switcher">
		...
		<div id="color-switcher-content" class="content">
			<a href="#" data-color="red" class="item js__change_color"><span
				class="color" style="background-color: #f44336;"></span><span
				class="text">Red</span></a> <a href="#" data-color="violet"
				class="item js__change_color"><span class="color"
				style="background-color: #673ab7;"></span><span class="text">Violet</span></a>
			<a href="#" data-color="dark-blue" class="item js__change_color"><span
				class="color" style="background-color: #3f51b5;"></span><span
				class="text">Dark Blue</span></a> <a href="#" data-color="blue"
				class="item js__change_color active"><span class="color"
				style="background-color: #304ffe;"></span><span class="text">Blue</span></a>
			<a href="#" data-color="light-blue" class="item js__change_color"><span
				class="color" style="background-color: #2196f3;"></span><span
				class="text">Light Blue</span></a> <a href="#" data-color="green"
				class="item js__change_color"><span class="color"
				style="background-color: #4caf50;"></span><span class="text">Green</span></a>
			<a href="#" data-color="yellow" class="item js__change_color"><span
				class="color" style="background-color: #ffc107;"></span><span
				class="text">Yellow</span></a> <a href="#" data-color="orange"
				class="item js__change_color"><span class="color"
				style="background-color: #ff5722;"></span><span class="text">Orange</span></a>
			<a href="#" data-color="chocolate" class="item js__change_color"><span
				class="color" style="background-color: #795548;"></span><span
				class="text">Chocolate</span></a> <a href="#" data-color="dark-green"
				class="item js__change_color"><span class="color"
				style="background-color: #263238;"></span><span class="text">Dark
					Green</span></a> <span id="color-reset"
				class="btn-restore-default js__restore_default">Reset</span>
		</div>
		<!-- /.content -->
	</div>
	<!-- #color-switcher -->
			...
			<div class="row small-spacing">
				<div class="col-12">
					<div class="box-content">
						...
						<div id="smil-animation-index-chartist-chart"
							class="chartist-chart" style="height: 320px"></div>
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content">
						...
						<div class="content widget-stat">
							<div class="percent bg-warning">
								<i class="fas fa-chart-line"></i>53%
							</div>
							<!-- /.percent -->
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content">
						...
						<!-- /.dropdown js__dropdown -->
						<div class="content widget-stat">
							<div class="percent bg-danger">
								<i class="fas fa-chart-line"></i>+40%
							</div>
							<!-- /.percent -->
							<div class="right-content">
					...
					<div class="box-content">
						...
						<div class="content">
							<div id="chart-1" class="js__chart" data-type="donut"
								data-chart="'Type'/'Number' | 'Normal Sales'/50 | 'In-Site Sales'/20 | 'Mail-Order Sales'/20"></div>
						</div>
						<!-- /.content -->
					</div>
					<!-- /.box-content -->
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content user-info">
						<div class="avatar">
							<img src="adminResources/image/avatar-1.jpg" alt="">
						</div>
						<!-- /.avatar -->
						<div class="right-content">
							...
							<p>
								<a
									href="/cdn-cgi/l/email-protection#f098959c9c9fb09e999e9a918495919dde9f8297"><span
									class="__cf_email__"
									data-cfemail="fa929f969695ba949394909b8e9f9b97d495889d">[email&#160;protected]</span></a>
							</p>
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content user-info">
						<div class="avatar">
							<img src="adminResources/image/avatar-2.jpg" alt="">
						</div>
						<!-- /.avatar -->
						<div class="right-content">
							...
							<p>
								<a
									href="/cdn-cgi/l/email-protection#2f474a4343406f414641454e5b4a4e4201405d48"><span
									class="__cf_email__"
									data-cfemail="9ff7faf3f3f0dff1f6f1f5feebfafef2b1f0edf8">[email&#160;protected]</span></a>
							</p>
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content user-info">
						<div class="avatar">
							<img src="adminResources/image/avatar-3.jpg" alt="">
						</div>
						<!-- /.avatar -->
						<div class="right-content">
							...
							<p>
								<a
									href="/cdn-cgi/l/email-protection#523a373e3e3d123c3b3c38332637333f7c3d2035"><span
									class="__cf_email__"
									data-cfemail="d1b9b4bdbdbe91bfb8bfbbb0a5b4b0bcffbea3b6">[email&#160;protected]</span></a>
							</p>
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box-content user-info">
						<div class="avatar">
							<img src="adminResources/image/avatar-4.jpg" alt="">
						</div>
						<!-- /.avatar -->
						<div class="right-content">
							...
							<p>
								<a
									href="/cdn-cgi/l/email-protection#90f8f5fcfcffd0fef9fefaf1e4f5f1fdbeffe2f7"><span
									class="__cf_email__"
									data-cfemail="cca4a9a0a0a38ca2a5a2a6adb8a9ada1e2a3beab">[email&#160;protected]</span></a>
							</p>
	...
	<script data-cfasync="false"
		src="adminResources/js/email-decode.min.js"></script>
	...
	<!-- Google Chart -->
	<script type="text/javascript" src="adminResources/js/loader.js"></script>
