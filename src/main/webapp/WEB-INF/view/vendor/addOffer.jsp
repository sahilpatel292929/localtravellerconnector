					...
					<div class="box-content">
						<form data-toggle="validator">
					        ...
					        <div class="form-group">
								<label for="inputName" class="control-label">Start From</label> <input
									type="text" class="form-control" id="inputName"
									placeholder="Start From" required>
							</div>
					   
							<div class="form-group">
								<label for="inputName" class="control-label">End to</label> <input
									type="text" class="form-control" id="inputName"
									placeholder="End to" required>
							</div>
							<div class="form-group">
								<label for="inputName" class="control-label">Offer Name</label> <input
									type="text" class="form-control" id="inputName"
									placeholder="Offer Name" required>
							</div>
							<div class="form-group">
								<label for="inputName" class="control-label">Product</label> <input
									type="text" class="form-control" id="inputName"
									placeholder="Product" required>
							</div>
							<div class="form-group">
								<label for="inputName" class="control-label">Description</label> <input
									type="text" class="form-control" id="inputName"
